...
function mostrarAutos(autos) {
  ...
  autos.forEach((auto) => {
    ...
    autoHTML.classList.add("product__item");
    autoHTML.innerHTML = `<img src="${imagen}" class="product__img" alt="">
       
    <div class="product__text" style="--i:${codigo}">
    <h3 class="product__marca">${marca}</h3>
   <h2 class="product__name">${modelo}</h2>
    <div class="product__informacion">
        <div class="product__dato">
    ...
    productos.appendChild(autoHTML);
  });
}
...
function noResultado() {
  ...
  noResultado.textContent = "No resultados";

  productos.appendChild(noResultado);
}
